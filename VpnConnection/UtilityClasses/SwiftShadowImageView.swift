...
//    @IBInspectable override var borderWidth: CGFloat = 0.00 { didSet { self.layer.borderWidth = self.borderWidth } }
//    @IBInspectable override var cornerRadius: CGFloat = 0.00 {
//        didSet {
